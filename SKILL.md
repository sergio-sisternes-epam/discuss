...
If the user asked how to get started with Discuss, said they are new to Discuss, asked how Discuss works, asked how to start a durable discussion graph, asked for a useful first step with Discuss, or showed first-use intent clearly about Discuss, load **speak**, then enter path **getting-started** (`references/paths/getting-started.md`). Do not enter path **help**.
